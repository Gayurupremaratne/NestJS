/*
  ...
  - The values [HICKER_IMAGE] on the enum `STAGE_MEDIA_KEY_TYPES` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "STAGE_MEDIA_KEY_TYPES_new" AS ENUM ('MAIN_IMAGE', 'SUPPLIMENTARY_IMAGE', 'ELEVATION_GRAPH_IMAGE', 'HIKER_IMAGE');
